...
<div id="mainForm" class="form">
    <form action="/editchart/{{ $chart->id }}" method="POST">

        @csrf
        <div class="mt-3 form-group">
            <label for="chartName">Chart Name</label>
            <input type="text" class="form-control" id="chartName" placeholder="Enter Chart Name" value="{{ $chart->chart_name }}"
        ...
        <div class="mt-3 form-group">
            ...
            <select class="form-control" id="chart" value="{{ $chart->chart_type }}" name="chartType">
                <option>pie</option>
                <option>line</option>
            </select>
        </div>
            ...
            <p style="font-size: 12px;" for="chartJsonData">Example of formatter Json ->
                {"YjKMR":271,"WYox6":939,"BG1VE":406,"2ULc1":917} <- </p>
                    ...
                    <input type="text" class="form-control" id="chartJsonData" placeholder="Enter Chart json data"
                        value="{{ $chart->raw_data }}" name="chartJsonData" maxlength="850" required>
        </div>
        ...
        <button style="margin:auto;" type="submit" class="mt-3 button btn btn-success btn-lg center-block"
            id="submitBtn">Update Chart</button>
