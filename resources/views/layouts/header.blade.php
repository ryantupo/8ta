                        ...
                        <div id="myDropdown" class="dropdown-content">
                            ...
                            @foreach (json_decode($usercharts, true) as $data)
                                <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <button style="" type="button" class="bi bi-trash btn">                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
