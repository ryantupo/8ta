                            ...
                            @foreach (json_decode($usercharts, true) as $data)
                                <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <form method="POST" id="delete-form" action="/deletechart/{{ $data['id'] }}">
                                        {{csrf_field()}}
                                        <button style="margin-top:10px;" name="_method" value="post" type="submit" class="bi bi-trash btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
